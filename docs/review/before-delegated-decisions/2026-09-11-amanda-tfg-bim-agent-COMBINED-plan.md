...
- [ ] Verify the recorded PROGRAM_BASELINE decision (PDF, 20 people; resolved 2026-09-15) and source hash remain applicable. Require resolved TYPOLOGY and valid SITE_BOUNDARY for the chosen production scope. A changed program source needs version reconciliation; do not reopen the already answered baseline choice without a material change.
