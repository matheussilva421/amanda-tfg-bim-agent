...
## 4. Decisão do usuário e pendências de projeto
...
Começar por [START_HERE_FOR_CODEX.md](START_HERE_FOR_CODEX.md) e pelo [handoff](docs/notes/2026-09-15-revisao-planos-handoff.md). Próxima implementação: M1/01, se solicitada. PROGRAM_BASELINE está resolvido por decisão do usuário: adotar o PDF de 20 pessoas. Registrar essa seleção com hash na futura ingestão; resolver as demais decisões antes das tarefas dependentes. Essa escolha não autoriza automaticamente implementar o agente ou iniciar BIM detalhado.
