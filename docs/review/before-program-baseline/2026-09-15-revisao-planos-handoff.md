...
- Conflito explícito: PDF prevê 20 pessoas, 626 m² internos/260 m² externos; planilha pressupõe 12 famílias × 3,5 = 42 pessoas. PROGRAM_BASELINE permanece decisão humana antes da produção; não houve escolha silenciosa.
...
4. Resolver PROGRAM_BASELINE, TYPOLOGY, SITE_BOUNDARY/SITE_OCCUPANCY, normas/topografia e seleção antes das tarefas dependentes.
...
Reversão documental: comparar/restaurar explicitamente os quatro backups somente se desejado; depois regenerar filhos/ZIP. Fontes acadêmicas e ZIP recebido permanecem originais.
