...
**Pesquisa realizada em:** 25/09/2026. **Escopo:** busca limitada a fontes públicas primárias da Prefeitura do Natal, Governo do RN/PMRN/SESED e Diário Oficial/registro oficial. Termos cobertos: BPChoque/CPChoque, Av. Miguel Castro, cadastro/lote/parcela, topografia/levantamento, transferência/realocação/disponibilidade, frentes e norte. Nenhuma agência foi contatada; não houve pedido e-SIC, login, download de artefato, acesso a RVT/Revit ou alteração de estado do projeto.
...
- A página inicial do GeoNatal lista camadas de lotes e curvas de nível. Porém, em 25/09/2026, outras rotas no mesmo domínio oficial exibiam páginas de apostas/aplicativos e conteúdo promocional alheio a cartografia, inclusive conteúdo marcado como atualizado em 16/09/2026. **Anomalia de conteúdo:** por cautela, não usei essas rotas nem as camadas como evidência cadastral; a observação não demonstra que as camadas oficiais estejam comprometidas e elas precisam de validação específica. [GeoNatal](https://geomapas.natal.rn.gov.br/), [rota com conteúdo de apostas](https://geomapas.natal.rn.gov.br/app/2026-05-13/cadastro-ganhou/), [outra rota com conteúdo alheio à cartografia](https://geomapas.natal.rn.gov.br/app/Neymar-crian%C3%A7a.html)
- **Resultado limitado:** esta busca não encontrou fonte oficial pública que forneça o polígono cadastral deste lote, coordenadas/CRS, levantamento topográfico do terreno ou datum altimétrico. Também não encontrou base oficial íntegra e verificável para extrair esses valores.
...
A página do GeoNatal anuncia camadas de lotes/logradouros. Como foram observadas rotas com conteúdo alheio à cartografia no mesmo domínio, essas camadas foram excluídas por cautela, pendentes de validação específica. Esta busca não encontrou outra fonte oficial pública e verificável que determine o número de frentes do lote ou o azimute/referência de norte verdadeiro aplicável ao terreno.
...
|---|---|---|
| `SITE_BOUNDARY` | **BLOCKING — não resolvido** | Nenhum polígono/coordenadas/CRS oficial do lote encontrado nesta busca. |
